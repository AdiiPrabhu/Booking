...
import com.main.test4.fragment.CoursesFragment;
import com.main.test4.model.CommanderApplication;
...
public class CoursesActivity extends AppCompatActivity implements CoursesFragment.OnCourseSelectedListener, CourseDetailFragment.OnAddCourseListener {
    ...
    public void onCourseSelected(Course course) {
        ...
        FrameLayout fragmentLayout = (FrameLayout) findViewById(R.id.fragment_course_detail);
        if (fragmentLayout != null) {
            ...
            getFragmentManager().beginTransaction().replace(R.id.fragment_course_detail, fragment).commit();
        } else {
