...
import com.main.test4.activity.CoursesActivity;
import com.main.test4.activity.MainActivity;
...
public class TableDetailFragment extends Fragment {
    ...
    private void updateTableCourses() {
        ...
        if (table != null) {
            ArrayList<CoursesAdapter.CourseAdapterItem> courses = ((Table) table).getCourses().getArray(getActivity());
