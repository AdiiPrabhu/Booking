...
import com.main.test4.model.Allergen;
import com.main.test4.model.Course;
import com.main.test4.model.CourseCategory;
...
public class CoursesAdapter extends ArrayAdapter<CoursesAdapter.CourseAdapterItem> {
    ...
    public CoursesAdapter(Context context, int resource, ArrayList<CourseAdapterItem> objects) {
